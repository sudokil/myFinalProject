(function( $ ) {
    ...
    $.Shop.prototype = {
        init: function() {
            ...
            this.currency = "&#8381;";
            this.currencyString = "₽";
            this.paypalCurrency = "RUB";
            this.paypalBusinessEmail = "mybusinessmailblabla@email.com";
        ...
        // Создание ключей корзины в session storage
        ...
        // PayPal API - добавление требуемых скрытых значений в форму
            ...
            if( this.$userDetails.length ) {
                if( this.storage.getItem( "shipping-name" ) == null ) {
                    ...
                    var html = "<div class='detail'>";
                        html += "<h2>Адрес оплаты/доставки</h2>";
                        html += "<ul>";
                        html += "<li>" + name + "</li>";
                        html += "<li>" + email + "</li>";
                        html += "<li>" + city + "</li>";
        ...
        // Опустошаем корзину путём вызова метода _emptyCart()
        // @see $.Shop._emptyCart()
        ...
        // Обрабатываем форму оформления заказа путем добавления процедуры проверки и сохранения информации о пользователе в хранилище сеансов
        ...
        // Освобождаем пространство для хранения сессии
        
        _emptyCart: function() {
            this.storage.clear();
        },
        
        /* Формат числа по десятичным разрядам
         * @param num Number - число для форматирования
         * @param places Number - десятичные разряды
         * @returns n Number - отформатированное число
         */
        ...
        /* Извлекаем числовой части из строки
         * @param element Object the jQuery - элемент, который содержит соответствующую string
         * @returns price String - числовая строка
         */
        ...
        /* Преобразовываем numeric string в номер
         * @param numStr String - числовая строка для преобразования
        ...
        /* Преобразовываем number в string
         * @param n Number - номер для преобразования
         * @returns str String - возвращаемая строка
         */
        ...
        /* Преобразовываем JSON string в объект JavaScript
         * @param str String - JSON строка
         * @returns obj Object объект JavaScript
         */
        ...
        /* Преобразовываем объект JavaScript в JSON строку
         * @param obj Object объект JavaScript
         * @returns str String строка JSON
         */
        ...
        /* Объект в корзину как JSON-строка
         * @param values Object - объект, добавляемый в корзину
         * @returns void
         */
        ...
        /* Расчёт стоимости доставки на основе общего количества товаров в корзине
         * @param qty Number - общее количество товаров
         * @returns shipping Number - стоимость доставки
         */
         ...
         * @param form Object the jQuery - элемент checkout-формы
         * @returns valid Boolean - true если успех, false если ошибка
         */
        ...
        /* Сохранение данных, введенных пользователем в форму блокировки ckeckout
         * @param form Object the jQuery - элемент checkout-формы
         * @returns void
         */
